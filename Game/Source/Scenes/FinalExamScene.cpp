...
FinalExamScene::FinalExamScene(fw::GameCore* pGameCore) : Scene(pGameCore)
{
...
FinalExamScene::~FinalExamScene()
{
}

void FinalExamScene::ExecuteEvent(fw::Event* pEvent)
{

}

void FinalExamScene::StartFrame(float deltaTime)
{
	Super::StartFrame(deltaTime);
}

void FinalExamScene::Update(float deltaTime)
{
...
fw::Camera* FinalExamScene::GetCamera()
{
